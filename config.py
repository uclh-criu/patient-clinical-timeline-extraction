...
# Valid options: 'imaging', 'synthetic', 'synthetic_multi', 'nph', 'notes_multi'
...
MODEL_PATH = 'custom_model_training/models/synthetic_multi_custom.pt'  
VOCAB_PATH = 'custom_model_training/vocabs/synthetic_multi_vocab.pt'
...
BERT_MODEL_PATH = './bert_model_training/models/synthetic_bert_model'
BERT_CONFIDENCE_THRESHOLD = 0.14  # Confidence threshold for BERT predictions
...
NOTES_MULTI_DATA_PATH = 'data/notes_multi.csv'
