...
VOCAB_PATH = 'custom_model_training/vocabs/vocab_synthetic.pt'  # Path to vocabulary file for this dataset
MAX_DISTANCE = 200 # Maximum distance between diagnosis and date to consider
MAX_CONTEXT_LEN = 64  # Maximum context length for text window around entities
